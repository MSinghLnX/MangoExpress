...
def demo(cursor, connection):
    ...
    #studentData = [ {"name": "python", "hofstra_ID": "h0"}, {"name": "java", "hofstra_ID": "h0"} ]
    #cursor.execute("INSERT INTO students (name, hofstra_ID) VALUES (%s, %s)", (studentData[{"name"}], studentData[{"hofstra_ID"}]))
